<template>
    <div class="bg-white">
        ...
        <section class="relative h-[280px] sm:h-[320px] w-full overflow-hidden">
            <!-- background image -->
            <img :src="headerBg" alt="Tour Packages header" loading="lazy" class="absolute inset-0 h-full w-full object-cover" />
            <!-- overlay -->
                ...
                <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                   ...
                   overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.12)]">
                        ...
                        <div class="relative h-[140px] overflow-hidden">
                            <LazyImage
                                :src="pkg.image || '/assets/img/tour/tour-bg.jpg'"
                                :alt="pkg.title"
                                fallback="/assets/img/tour/tour-bg.jpg"
