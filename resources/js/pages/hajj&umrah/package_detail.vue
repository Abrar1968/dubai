            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-24 bg-white rounded-2xl shadow-lg border border-slate-100 p-6 overflow-hidden">
                        ...
                        <button @click="scrollToContact" class="w-full py-4 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-xl transition shadow-lg hover:shadow-orange-500/25 flex items-center justify-center gap-2">
                            Book This Package
...
const itineraryList = computed(() => {
    ...
    // Mock itinerary if empty
    return [
        { title: 'Day 1: Arrival', description: 'Arrive at Jeddah airport, transfer to hotel.' },
        { title: 'Day 2: Umrah', description: 'Perform Umrah rituals with guide support.' },
        { title: 'Day 3: Ziyarat', description: 'Visit historical sites in Makkah.' },
    ];
});
