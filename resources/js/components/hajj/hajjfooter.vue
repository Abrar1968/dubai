...
// Extract social links that are not empty
const socialLinks = [
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div class="flex flex-col gap-6">
                ...
                <nav class="flex flex-col gap-4 text-sm text-white">
                    <a href="/hajj-umrah#services" class="hover:text-gray-300 transition-colors">Services</a>
                    <a href="/hajj-umrah#features" class="hover:text-gray-300 transition-colors">Features</a>
                    <a href="/hajj-umrah#testimonials" class="hover:text-gray-300 transition-colors">Testimonials</a>
                    <a href="/hajj-umrah#packages" class="hover:text-gray-300 transition-colors">Packages</a>
                </nav>
            </div>
            ...
            <div class="flex flex-col gap-6">
                ...
                <nav class="flex flex-col gap-4 text-sm text-white">
                    <a href="/hajj-umrah/team" class="hover:text-gray-300 transition-colors">About Us</a>
                    ...
                    <a href="/hajj-umrah/team" class="hover:text-gray-300 transition-colors">Career</a>
