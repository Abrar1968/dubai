        ...
        <div class="h-16 sm:h-20 md:h-24 lg:h-28 flex items-center justify-between">
          ...
          <div class="flex items-center gap-3">
            ...
            <button
              ...
              class="lg:hidden h-10 w-10 sm:h-11 sm:w-11 rounded-xl border border-slate-200 grid place-items-center hover:bg-slate-50 transition dark:text-black dark:hover:bg-slate-800 dark:border-slate-700"
    ...
    <div v-if="mobileOpen" class="lg:hidden fixed inset-0 z-50 bg-black/50" @click="mobileOpen = false">
      <div class="absolute right-0 top-0 h-full w-80 max-w-[85vw] bg-white shadow-xl overflow-y-auto" @click.stop>
        <div class="p-4 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
          <span class="font-bold text-lg dark:text-black">Menu</span>
          <button @click="mobileOpen = false" class="p-2 hover:bg-slate-100 rounded-lg dark:bg-slate-800">
            <X class="w-5 h-5" />
          </button>
        </div>
        <nav class="p-4 space-y-1">
          <a href="/" class="block px-4 py-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 font-medium dark:text-black">Home</a>

          <!-- Services Accordion -->
          <div>
            <button @click="mobileServicesOpen = !mobileServicesOpen" class="w-full flex items-center justify-between px-4 py-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 font-medium dark:text-black">
              Services
            ...
            <div v-if="mobileServicesOpen" class="pl-4 space-y-1 max-h-64 overflow-y-auto">
              <a href="/typing/services/immigration" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Immigration</a>
              <a href="/typing/services/labour-ministry" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Labour Ministry</a>
              <a href="/typing/services/tasheel-services" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Tasheel Services</a>
              <a href="/typing/services/domestic-workers-visa" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Domestic Workers Visa</a>
              <a href="/typing/services/family-visa-process" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Family Visa Process</a>
              <a href="/typing/services/health-insurance" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Health Insurance</a>
              <a href="/typing/services/ministry-of-interior" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Ministry of Interior</a>
              <a href="/typing/services/certificate-attestation" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Certificate Attestation</a>
              <a href="/typing/services/vat-registration" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">VAT Registration</a>
              <a href="/typing/services/ct-registration" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">CT Registration</a>
              <a href="/typing/services/passport-renewal" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Passport Renewal</a>
              <a href="/typing/services/immigration-card" class="block px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-black text-sm">Immigration Card</a>
            </div>
          </div>

          <a href="/typing/contact" class="block px-4 py-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 font-medium dark:text-black">Contact Us</a>

          <!-- Auth Links -->
          <div class="border-t border-slate-200 mt-4 pt-4">
            <template v-if="isRegularUser()">
              <a href="/user/dashboard" class="block px-4 py-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 font-medium dark:text-black">Dashboard</a>
              <a href="/user/bookings" class="block px-4 py-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 font-medium dark:text-black">My Bookings</a>
              <a href="/user/profile" class="block px-4 py-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 font-medium dark:text-black">Profile</a>
              <button @click="logout" class="w-full text-left px-4 py-3 rounded-lg hover:bg-red-50 dark:hover:bg-red-700 font-medium text-red-600">Logout</button>
            </template>
            <template v-else>
              <Link href="/login" class="block px-4 py-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 font-medium dark:text-black">Login</Link>
              <Link href="/register" class="block px-4 py-3 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 font-medium dark:text-black">Register</Link>
            </template>
          </div>
        </nav>
      </div>
