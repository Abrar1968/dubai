<x-admin.layouts.app title="Add Team Member">
    <div class="mx-auto max-w-3xl">
        ...
        <div class="mb-6">
            ...
            <h1 class="mt-2 text-2xl font-bold text-gray-900">Add Team Member</h1>
        </div>

        <form action="{{ route('admin.hajj.team.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
                    ...
                    <div>
                        ...
                        <div class="mt-2" x-data="{ preview: null }">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <input type="file" name="image" id="image" accept="image/jpeg,image/jpg,image/png,image/gif,image/webp,image/svg+xml,image/heic,image/heif" class="hidden" @change="preview = URL.createObjectURL($event.target.files[0])">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">JPEG, PNG, GIF, WebP, SVG, HEIC. Max 5MB.</p>
                                </div>
                            </div>
                            @error('image')
