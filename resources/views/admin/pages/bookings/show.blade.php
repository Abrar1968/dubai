            ...
            @if($booking->package)
                <x-admin.ui.card>
                    ...
                    <div class="flex gap-4">
                        @if($booking->package->thumbnail)
                            <img src="{{ Storage::url($booking->package->thumbnail) }}" alt="{{ $booking->package->title }}" class="h-24 w-32 object-cover rounded-lg flex-shrink-0">
                        @endif
                        <div>
