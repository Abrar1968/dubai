<x-admin.layouts.app title="Edit {{ $visaType->name }} - {{ $emirate->name }}">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Edit Visa Type</h1>
            <p class="mt-1 text-sm text-gray-500">Update {{ $visaType->name }} in {{ $emirate->name }}.</p>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.typing.family-visa.types.update', [$emirate, $visaType]) }}" method="POST"
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $visaType->name) }}" required
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="short_description" id="short_description" value="{{ old('short_description', $visaType->short_description) }}"
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="long_description" id="long_description" rows="4"
                                  class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500"
                                  placeholder="Detailed description shown on visa type detail page">{{ old('long_description', $visaType->long_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="processing_time" id="processing_time" value="{{ old('processing_time', $visaType->processing_time) }}"
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="price_range" id="price_range" value="{{ old('price_range', $visaType->price_range) }}"
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500"
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="cta_text" id="cta_text" value="{{ old('cta_text', $visaType->cta_text ?? 'Get Started') }}"
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="cta_link" id="cta_link" value="{{ old('cta_link', $visaType->cta_link ?? '/typing/contact') }}"
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500"
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $visaType->sort_order) }}" min="0"
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Status</label>
                        <label class="relative inline-flex items-center cursor-pointer mt-2">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $visaType->is_active) ? 'checked' : '' }} class="sr-only peer">
    ...
    <script>
        function visaTypeForm() {
            return {
                requirements: @json(old('requirements', $visaType->requirements ?? [])),
                documents: @json(old('documents', $visaType->documents ?? [])),
                processSteps: @json(old('process_steps', $visaType->process_steps ?? [])),
                addRequirement() {
