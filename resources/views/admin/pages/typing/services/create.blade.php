<x-admin.layouts.app title="Add Typing Service">
    <div class="space-y-6">
        <!-- Header -->
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Add Typing Service</h1>
                <p class="mt-1 text-sm text-gray-500">Create a new typing service with sub-services.</p>
            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <label class="relative inline-flex cursor-pointer items-center">
                                    ...
                                    <input type="checkbox" name="is_featured" value="1" id="is_featured" class="peer sr-only" {{ old('is_featured') ? 'checked' : '' }}>
