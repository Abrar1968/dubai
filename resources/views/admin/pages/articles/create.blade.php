        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <x-admin.ui.card>
                    ...
                    <x-admin.form.image-upload name="featured_image" label="Featured Image" required accept="image/jpeg,image/jpg,image/png,image/gif,image/webp,image/svg+xml,image/heic,image/heif" maxSize="5120" hint="Recommended: 1200x630px for social sharing" />
                </x-admin.ui.card>
            </div>
        </div>
    </form>
