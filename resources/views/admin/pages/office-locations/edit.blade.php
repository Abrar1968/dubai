                    ...
                    <x-admin.ui.card>
                        ...
                        <div class="space-y-4">
                            <x-admin.ui.select
                                ...
                                required
                            >
                                <option value="global" {{ old('section', $location->section) === 'global' ? 'selected' : '' }}>Global (All Sections)</option>
                                <option value="hajj" {{ old('section', $location->section) === 'hajj' ? 'selected' : '' }}>Hajj & Umrah</option>
                                <option value="tour" {{ old('section', $location->section) === 'tour' ? 'selected' : '' }}>Tour & Travel</option>
                                <option value="typing" {{ old('section', $location->section) === 'typing' ? 'selected' : '' }}>Typing Services</option>
                            </x-admin.ui.select>
