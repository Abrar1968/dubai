            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <x-admin.ui.card>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <x-admin.ui.input type="number" name="price" label="Price ($)" :value="old('price', $package->price)" required min="0" step="0.01" placeholder="0.00" />

                        <x-admin.ui.input type="number" name="discounted_price" label="Discounted Price ($)" :value="old('discounted_price', $package->discounted_price)" min="0" step="0.01" placeholder="0.00" hint="Leave empty for no discount" />
