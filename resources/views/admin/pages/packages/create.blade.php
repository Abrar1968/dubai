        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <x-admin.ui.card>
                    ...
                    <x-admin.form.image-upload name="thumbnail" label="Package Thumbnail" required accept="image/jpeg,image/png,image/jpg,image/webp" maxSize="2" hint="Recommended: 800x600px" />
                </x-admin.ui.card>
                ...
                <x-admin.ui.card>
                    ...
                    <x-admin.form.multi-image-upload name="gallery" label="Gallery Images" accept="image/jpeg,image/png,image/jpg,image/webp" maxSize="2" maxFiles="10" hint="Upload up to 10 images" />
                </x-admin.ui.card>
            </div>
        </div>
    </form>
