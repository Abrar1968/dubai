...
class TypingServiceRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'featured_image.mimes' => 'The featured image must be a valid image file (jpeg, jpg, png, gif, webp, svg, heic, heif).',
            'featured_image.max' => 'The featured image may not be larger than 10MB.',
            'gallery_images.*.image' => 'Each gallery item must be an image.',
            'gallery_images.*.mimes' => 'Gallery images must be valid image files (jpeg, jpg, png, gif, webp, svg, heic, heif).',
            'gallery_images.*.max' => 'Each gallery image may not be larger than 10MB.',
