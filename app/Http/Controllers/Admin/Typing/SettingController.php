...
class SettingController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('admin.pages.typing.settings.index', [
            'settings' => $settings,
        ]);
    }
    ...
    public function updateCompany(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'company_values' => ['nullable', 'string', 'max:1000'],
            'company_logo' => ['nullable', 'image', 'mimes:jpeg,jpg,png,gif,webp,svg,heic,heif', 'max:5120'],
            'banner_image' => ['nullable', 'image', 'mimes:jpeg,jpg,png,gif,webp,svg,heic,heif', 'max:10240'],
            'hero_image' => ['nullable', 'image', 'mimes:jpeg,jpg,png,gif,webp,svg,heic,heif', 'max:10240'],
        ]);

        // Handle logo upload
        if ($request->hasFile('company_logo')) {
            $oldLogo = $this->settingService->get('company_logo', 'typing');
            if ($oldLogo) {
        ...
        $this->settingService->setMany($validated, 'typing');

        return redirect()
            ->route('admin.typing.settings.index')
    ...
    public function updateSeo(Request $request): RedirectResponse
    {
        ...
        if ($request->hasFile('og_image')) {
            $oldImage = $this->settingService->get('og_image', 'typing');
            if ($oldImage) {
        ...
        return redirect()
            ->route('admin.typing.settings.index', ['tab' => 'seo'])
    ...
    public function updateSocial(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.typing.settings.index', ['tab' => 'social'])
    ...
    public function updateContact(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.typing.settings.index', ['tab' => 'contact'])
